...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/postgres/generated/client",
    "postgres/generated/client",
  ]
...
path.join(process.cwd(), "prisma/postgres/generated/client/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/postgres/generated/client/schema.prisma")
